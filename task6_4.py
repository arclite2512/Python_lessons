...
car = Car('белый', 'Kia Ceed', False)
test_drive(car)

passat = TownCar('черный', 'Volkswagen Passat')
test_drive(passat)

ferrari = SportCar('желтый', 'Ferrari F40')
test_drive(ferrari)

largus = WorkCar('зеленый', 'Lada Largus')
test_drive(largus)

dodge = PoliceCar('синий', 'Dodge Charger Pursuit')
test_drive(dodge)
